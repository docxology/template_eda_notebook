...
`measurements.csv` is a static fixture generated once with a fixed seed; it is
the source of truth for every statistic in the manuscript. Generated analysis
outputs (figures, summary CSV) belong under `output/` during pipeline runs, not
here.
